...
public class RessourcesHumainesController  implements Initializable{
	  ...
	  /* @FXML
	    public void HandleEvents1(MouseEvent event) {
		   try {
               ...
               //stage.setMaximized(true);
               stage.close();
               Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/org/example/views/gestionEquipe.fxml")));
               stage.setScene(scene);
               stage.show();
